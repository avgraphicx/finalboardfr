<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar" id="sidebar-scroll">
        <nav class="main-menu-container nav nav-pills flex-column">
            ...
            <ul class="main-menu">
                <li class="slide__category"><span class="category-name">Backend Menu</span></li>
                <li class="slide">
                    <a href="{{ route('backend.dashboard') }}"
                        class="side-menu__item {{ request()->routeIs('backend.dashboard') ? 'active' : '' }}">
                ...
                <li class="slide">
                    <a href="{{ route('backend.users.index') }}"
                        class="side-menu__item {{ request()->routeIs('backend.users.index') ? 'active' : '' }}">
                        <i class="ri-group-line side-menu__icon"></i>
                        <span class="side-menu__label">Users</span>
                    </a>
                </li>
                <!-- Add more backend menu items here -->
            </ul>
