...
@section('content')
    <div class="page-header-breadcrumb mb-3 mt-4 mt-md-2">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">
                <a href="{{ route('drivers.index') }}" id="createDriverBtn" class="btn btn-primary">
                    <i class="ri-arrow-left-line me-2"></i>{{ __('messages.drivers_list') }}
                </a>

                <!-- ✅ Toast container directly under Drivers List -->

            </h1>

            <ol class="breadcrumb mb-0 d-none d-md-flex">
                <li class="breadcrumb-item">
                    <a href="javascript:void(0);">{{ __('messages.dashboard_menu') }}</a>
                </li>
            ...
            <div class="card custom-card dashboard-main-card primary">
                <div class="card-body text-center p-4">
                    ...
                    <h6 class="fw-semibold mt-3 mb-1">{{ $driver->driver_id }} - {{ $driver->full_name }}
                        <span class="p-1">
                            <a href="{{ route('drivers.edit', $driver->id) }}" id="editDriverBtn" class="fw-light fs-16"
    ...
    @if (session('success'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                notie.alert({
                    type: 1,
                    text: "{{ __('messages.driver_updated_successfully') }}",
                    stay: false,
                    time: 3,
                    position: 'top'
                });
