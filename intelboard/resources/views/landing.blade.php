    ...
    <header id="hero" class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4">{{ __('messages.hero_title') }} <span class="text-primary">Intelboard</span>
                    </h1>
                    <p class="lead my-4">
                                    ...
                                    <div class="card custom-card dashboard-main-card pricing-card">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'bronze', 'interval' => 'monthly']) }}"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card ">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'gold', 'interval' => 'monthly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card ">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'diamond', 'interval' => 'monthly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'bronze', 'interval' => 'quarterly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card ">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'gold', 'interval' => 'quarterly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card ">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'diamond', 'interval' => 'quarterly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'bronze', 'interval' => 'yearly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card ">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'gold', 'interval' => 'yearly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card custom-card dashboard-main-card pricing-card ">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-grid mt-auto">
                                                <a href="{{ route('register.show', ['plan' => 'diamond', 'interval' => 'yearly']) }}"
                                                    class="btn btn-lg btn-primary">{{ __('messages.get_started') }}</a>
                                            </div>
                                        </div>
                                    </div>
