...
<head>
    ...
    <title>Intelboard - Logistics Operations Management</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">Intelboard</a>
    ...
    <header id="hero" class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4">Manage Your Logistics Operations with <span
                            class="text-primary">Intelboard</span></h1>
                    <p class="lead my-4">
                        The all-in-one platform for logistics and transportation companies to manage drivers, track
                        invoices, and monitor payments efficiently.
                    </p>
                ...
                <div class="col-lg-6 mt-4 mt-lg-0">
                    <img src="https://placehold.co/600x400/e0f7ff/011a42?text=Platform+Dashboard"
                        ...
                        class="img-fluid rounded-3 shadow-lg" alt="Intelboard Dashboard Preview">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <span class="text-primary fw-bold text-uppercase small">CORE FEATURES</span>
                    <h2 class="section-title mt-2">Everything You Need to Succeed</h2>
                    <p class="mb-5 text-muted">Intelboard provides a comprehensive suite of tools to streamline every
                        aspect of your business operations.</p>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <h3 class="h5">Driver Management</h3>
                        <p class="text-muted small">Create and manage detailed driver profiles, track performance, set
                            commissions, and view earnings history by week.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <h3 class="h5">Invoice & Payment</h3>
                        <p class="text-muted small">Upload PDF invoices with automated validation. Track payments,
                            calculate driver benefits, and manage payment status in bulk.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted small">Access interactive dashboards showing driver performance, weekly
                            earnings, and key business graphs statistics.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <h3 class="h5">Financial Tracking</h3>
                        <p class="text-muted small">Automatically calculate commissions, bonuses, penalties, and net
                            payments. Keep a clear record of all financial transactions.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <h3 class="h5">Multi-Language & Themes</h3>
                        <p class="text-muted small">Full support for English and French, plus user-specific preferences
                            for light/dark mode to enhance usability.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <h2 class="section-title mt-2">A Simple, Powerful Workflow</h2>
                </div>
            </div>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-md">
                    <div class="workflow-step">
                        ...
                        <h3 class="h5">Add Drivers</h3>
                        <p class="text-muted small">Create profiles for your drivers with all necessary information and
                            payment settings.</p>
                    </div>
                </div>
                <!-- Step 2 -->
                <div class="col-md">
                    <div class="workflow-step">
                        ...
                        <h3 class="h5">Upload Invoices</h3>
                        <p class="text-muted small">Upload PDF invoices. The system validates the data against driver
                ...
                <div class="col-md">
                    <div class="workflow-step">
                        ...
                        <h3 class="h5">Calculate & Track</h3>
                        <p class="text-muted small">Intelboard calculates all commissions, benefits, and net pay. Track
                            payment status from unpaid to paid.</p>
                    </div>
                </div>
                <!-- Step 4 -->
                <div class="col-md">
                    <div class="workflow-step">
                        ...
                        <h3 class="h5">View Analytics</h3>
                        <p class="text-muted small">Monitor performance, track earnings, and generate reports from your
    ...
    <section id="analytics" class="section-padding bg-primary-light">
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <span class="text-primary fw-bold text-uppercase small">ANALYTICS & REPORTING</span>
                    <h2 class="section-title mt-2">Data-Driven Decisions</h2>
                    <p class="lead text-muted">Move beyond spreadsheets. Our interactive analytics dashboard gives you
                        a real-time view of your business health.</p>
                    <ul class="list-unstyled mt-4 fs-6"> <!-- Adjusted font size -->
                        <li class="mb-2 d-flex align-items-center"><i
                                class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> View total invoices vs.
                            driver benefits.</li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> Analyze weekly earnings
                            statistics.</li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> Track average metrics
                            across all drivers.</li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> Monitor key business
                            statistics at a glance.</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <img src="https://placehold.co/600x450/e0f7ff/011a42?text=Analytics+View"
                        ...
                        class="img-fluid analytics-image" alt="Intelboard Analytics Dashboard">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="pricing-heading-section text-center mb-5">
                    ...
                    <h2 class="fw-semibold mt-3 section-title">Choose the Right Plan for Your Needs</h2>
                    <span class="d-block text-muted fs-16 mb-3">Choose a plan that fits your needs with scalable
                        features and great value.</span>
                        ...
                        <ul class="nav nav-pills" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link rounded-pill fw-medium" data-bs-toggle="pill"
                                    ...
                                    tabindex="-1">Quarterly <span
                                        class="badge bg-success-transparent text-warning ms-1">Save 10%</span></button>
                            ...
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link rounded-pill fw-medium" data-bs-toggle="pill"
                                    ...
                                    tabindex="-1">Yearly <span
                                        class="badge bg-success-transparent text-success ms-1">Save 20%</span></button>
                                <!-- Added Quarterly Discount Badge -->
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M230.93,220a8,8,0,0,1-6.93,4H32a8,8,0,0,1-6.92-12c15.23-26.33,38.7-45.21,66.09-54.16a72,72,0,1,1,73.66,0c27.39,8.95,50.86,27.83,66.09,54.16A8,8,0,0,1,230.93,220Z"></path></svg>
                                            ...
                                            <p class="text-muted small">Perfect for starters with few drivers.</p>
                                            ...
                                            <ul class="list-unstyled pricing-features-list mb-4">
                                                <li>
                                                   ...
                                                   <span class="fw-medium">Add up to 10 drivers.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-close-circle-fill text-danger"></i>
                                                   <span class="fw-medium">Add unlimited drivers.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">View weekly statistics on the dashboard.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-close-circle-fill text-danger"></i>
                                                   <span class="fw-medium">Choose daily, weekly, monthly statistics.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Automatically calculate an invoice.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-close-circle-fill text-danger"></i>
                                                   <span class="fw-medium">Automatically calculate multiple invoices at a time.</span>
                                                </li>
                                                {{-- <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Add up to 10 drivers.</span>
                                                ...
                                                <li>
                                                   <i class="ri-close-circle-fill text-danger"></i>
                                                   <span class="fw-medium">Add supervisor account.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-close-circle-fill text-danger"></i>
                                                   <span class="fw-medium">Create custom company invoice.</span>
                                                </li>
                                            </ul>
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M164.47,195.63a8,8,0,0,1-6.7,12.37H10.23a8,8,0,0,1-6.7-12.37,95.83,95.83,0,0,1,47.22-37.71,60,60,0,1,1,66.5,0A95.83,95.83,0,0,1,164.47,195.63Zm87.91-.15a95.87,95.87,0,0,0-47.13-37.56A60,60,0,0,0,144.7,54.59a4,4,0,0,0-1.33,6A75.83,75.83,0,0,1,147,150.53a4,4,0,0,0,1.07,5.53,112.32,112.32,0,0,1,29.85,30.83,23.92,23.92,0,0,1,3.65,16.47,4,4,0,0,0,3.95,4.64h60.3a8,8,0,0,0,7.73-5.93A8.22,8.22,0,0,0,252.38,195.48Z"></path></svg>
                                            ...
                                            <h5 class="fw-semibold">Gold</h5>
                                            <p class="text-muted small">Designed for more drivers & multiple warehouses.</p>
                                            <div class="pricing-count my-3">
                                                <div class="d-flex align-items-end gap-1">
                                            ...
                                            <ul class="list-unstyled pricing-features-list mb-4">
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Add up to 50 drivers.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-close-circle-fill text-danger"></i>
                                                   <span class="fw-medium">Add unlimited drivers.</span>
                                                ...
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Automatically calculate up to 50 invoices at a time.</span>
                                                </li>
                                                {{-- <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Add up to 10 drivers.</span>
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M64.12,147.8a4,4,0,0,1-4,4.2H16a8,8,0,0,1-7.8-6.17,8.35,8.35,0,0,1,1.62-6.93A67.79,67.79,0,0,1,37,117.51a40,40,0,1,1,66.46-35.8,3.94,3.94,0,0,1-2.27,4.18A64.08,64.08,0,0,0,64,144C64,145.28,64,146.54,64.12,147.8Zm182-8.91A67.76,67.76,0,0,0,219,117.51a40,40,0,1,0-66.46-35.8,3.94,3.94,0,0,0,2.27,4.18A64.08,64.08,0,0,1,192,144c0,1.28,0,2.54-.12,3.8a4,4,0,0,0,4,4.2H240a8,8,0,0,0,7.8-6.17A8.33,8.33,0,0,0,246.17,138.89Zm-89,43.18a48,48,0,1,0-58.37,0A72.13,72.13,0,0,0,65.07,212,8,8,0,0,0,72,224H184a8,8,0,0,0,6.93-12A72.15,72.15,0,0,0,157.19,182.07Z"></path></svg>
                                            ...
                                            <h5 class="fw-semibold">Diamond</h5>
                                            <p class="text-muted small">For brokers with highest amount of drivers.</p>
                                            <div class="pricing-count my-3">
                                                <div class="d-flex align-items-end gap-1">
                                            ...
                                            <ul class="list-unstyled pricing-features-list mb-4">
                                                ...
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">View statistics on the dashboard.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Choose daily, weekly, monthly statistics.</span>
                                                ...
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Automatically calculate unlimited invoices at a time.</span>
                                                </li>
                                                {{-- <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">Add up to 10 drivers.</span>
                                                ...
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">VIP Support level.</span>
                                                </li>
                                                <li>
                                                   <i class="ri-checkbox-circle-fill text-success"></i>
                                                   <span class="fw-medium">First access to new features.</span>
                                                </li>
                                            </ul>
                                            <div class="d-grid mt-auto">
                                                <button class="btn btn-lg btn-primary">Get Started</button>
