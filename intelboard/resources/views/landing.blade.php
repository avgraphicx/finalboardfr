...
<section id="workflow" class="section-padding">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <span class="text-primary fw-bold text-uppercase small">{{ __('messages.how_it_works') }}</span>
            ...
            <div class="col-lg-6">
                ...
                <ul class="list-unstyled mt-4 fs-6"> <!-- Adjusted font size -->
                    <li class="mb-2 d-flex align-items-center"><i
                            class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> {{ __('messages.view_total_invoices') }}
                    </li>
                    <li class="mb-2 d-flex align-items-center"><i
                            class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> {{ __('messages.analyze_weekly_earnings') }}
                    </li>
                    <li class="mb-2 d-flex align-items-center"><i
                            class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> {{ __('messages.track_average_metrics') }}
                    </li>
                    <li class="mb-2 d-flex align-items-center"><i
                            class="bi bi-check-circle-fill text-primary me-2 fs-5"></i> {{ __('messages.monitor_key_stats') }}
                    </li>
                </ul>
            </div>
            <div class="col-lg-6">
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path
        d="M230.93,220a8,8,0,0,1-6.93,4H32a8,8,0,0,1-6.92-12c15.23-26.33,38.7-45.21,66.09-54.16a72,72,0,1,1,73.66,0c27.39,8.95,50.86,27.83,66.09,54.16A8,8,0,0,1,230.93,220Z"></path></svg>
                                                </span>
                                        </div>
                                        ...
                                        <ul class="list-unstyled pricing-features-list mb-4">
                                            ...
                                            <li>
                                                <i class="ri-checkbox-circle-fill text-success"></i>
                                                <span class="fw-medium">{{ __('messages.view_weekly_stats') }}</span>
                                            </li>
                                            <li>
                                                <i class="ri-close-circle-fill text-danger"></i>
                                                <span
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path
        d="M164.47,195.63a8,8,0,0,1-6.7,12.37H10.23a8,8,0,0,1-6.7-12.37,95.83,95.83,0,0,1,47.22-37.71,60,60,0,1,1,66.5,0A95.83,95.83,0,0,1,164.47,195.63Zm87.91-.15a95.87,95.87,0,0,0-47.13-37.56A60,60,0,0,0,144.7,54.59a4,4,0,0,0-1.33,6A75.83,75.83,0,0,1,147,150.53a4,4,0,0,0,1.07,5.53,112.32,112.32,0,0,1,29.85,30.83,23.92,23.92,0,0,1,3.65,16.47,4,4,0,0,0,3.95,4.64h60.3a8,8,0,0,0,7.73-5.93A8.22,8.22,0,0,0,252.38,195.48Z"></path></svg>
                                        ...
                                        <ul class="list-unstyled pricing-features-list mb-4">
                                            <li>
                                                <i class="ri-checkbox-circle-fill text-success"></i>
                                                <span class="fw-medium">{{ __('messages.add_up_to_50_drivers') }}</span>
                                            </li>
                                            <li>
                                                <i class="ri-close-circle-fill text-danger"></i>
                                                <span
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path
        d="M64.12,147.8a4,4,0,0,1-4,4.2H16a8,8,0,0,1-7.8-6.17,8.35,8.35,0,0,1,1.62-6.93A67.79,67.79,0,0,1,37,117.51a40,40,0,1,1,66.46-35.8,3.94,3.94,0,0,1-2.27,4.18A64.08,64.08,0,0,0,64,144C64,145.28,64,146.54,64.12,147.8Zm182-8.91A67.76,67.76,0,0,0,219,117.51a40,40,0,1,0-66.46-35.8,3.94,3.94,0,0,0,2.27,4.18A64.08,64.08,0,0,1,192,144c0,1.28,0,2.54-.12,3.8a4,4,0,0,0,4,4.2H240a8,8,0,0,0,7.8-6.17A8.33,8.33,0,0,0,246.17,138.89Zm-89,43.18a48,48,0,1,0-58.37,0A72.13,72.13,0,0,0,65.07,212,8,8,0,0,0,72,224H184a8,8,0,0,0,6.93-12A72.15,72.15,0,0,0,157.19,182.07Z"></path></svg>
                                        ...
                                        <ul class="list-unstyled pricing-features-list mb-4">
                                            ...
                                            <li>
                                                <i class="ri-checkbox-circle-fill text-success"></i>
                                                <span class="fw-medium">{{ __('messages.view_stats_dashboard') }}</span>
                                            </li>
                                            <li>
                                                <i class="ri-checkbox-circle-fill text-success"></i>
                                                <span
